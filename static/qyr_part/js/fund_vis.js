  ...
  */  
  ...
  $(function() {
    ...
    $('input[name="my-checkbox"]').on('switchChange.bootstrapSwitch', function(event, state) {
      ...
      if(state==true){//state true means that $ is selected , else % is selected
        ...
        .text("check-in times");//update axis label
  ...
  /**
    ...
    */  
  _init_funds("data/data-moving-3D.json"); 
  ...
  var line = d3.svg.line()
    .interpolate("linear")
    .x(function(d) { return x(parseDate(d.datetime+":00")); })
  ...
  var contextArea = d3.svg.area()
    ...
    .x(function(d) { return x2(parseDate(d.datetime+":00")); })
